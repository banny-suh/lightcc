            ...
            case '교회역사':
                ...
                const historyData = {
                    '2025년': [
                        ...
                        { date: '2025. 2. 1(토)', content: '2월 온가족 세벽예배 시작' },
                        { date: '2025. 2', content: '2월 한달간 매주 금요일 저녁 8시 기도회' },
                        { date: '2025. 2. 15(토)', content: `장애인 센터 '동심원' 섬김` },
                        { date: '2025. 2. 19(수) ~ 5.7(수)', content: '2025 하나님과 동행하는 삶 (하동삶)' },
                        { date: '2025. 2. 22(토)', content: '빛의교회 리더십수련회(일산 컴프에비뉴)' },
                        { date: '2025. 2. 28(금)', content: '생명을 주는 나무 봉사' },
                        { date: '2025. 3. 5(수)', content: '재의 수요일 예배(사순절 3/5 ~ 4/19)' },
                        { date: '2025. 3. 19(수) ~ 4. 30(수)', content: '2025 상반기 빛의교회 성경공부(성경 통독 프로젝트 1. 선지서) LBS 개강' },//==done
                        { date: '2025. 3. 21(금) ~ 22(토)', content: '2025 상반기 영선훈련 피정 1단계' },
                        { date: '2025. 3. 23(일)', content: 'LIGHT 도넛 데이 시작' },
                        { date: '2025. 5', content: '가정 예배 House Worship 책자 발행' },
                        { date: '2025. 5', content: 'Welcome Home 축제' },
                        { date: '2025. 5. 8(목)', content: '영덕 지품초등학교 꿈꾸는 운동화 전달' }
                    ],
                    '2024년': [
                        { date: '2024. 1. 6', content: '매월 첫째주 토요일 아침 7시 빛의 교회 온가족 새벽예배 시작' },
                        { date: '2024. 2. 6(화) ~ 15(목)', content: `겨울 케냐 아웃리치 '꿈꾸는 놀이터'` },
                        { date: '2024. 2. 22(목) ~ 7. 11(목)', content: `매주 목요일 저녁 8시 예배당 함께 나누기 '주는교회' 목요저녁예배` },
                        { date: '2024. 5. 5(일)', content: `빛의교회 교육부서 첫 연합예배 '와글와글 투게더'` },
                        { date: '2024. 6. 16(일)', content: '애니어그램 세미나 `참된 나를 찾아가는 내적여정`' },
                        { date: '2024. 7. 30(화) ~ 8. 5(월)', content: '여름 필리핀[두마게티] 아웃리치' },
                        { date: '2024. 8. 15(목)', content: '장애인 센터 섬김 시작' },
                        { date: '2024. 10. 2(수) ~ 23(수)', content: `4주 과정 가을 LBS '복음과 함께하는 삶'` },
                        { date: '2024. 10. 7(월) ~ 17(목)', content: `튀르키예 성지순례 '바울의 발자취를 따라서'` },
                        { date: '2024. 11. 1(금) ~ 2(토)', content: '빛의교회 국내성지순례2. 전주&군산' }
                    ],
                    '2023년': [
                        { date: '2023. 2. 2(목) ~ 3(금)', content: '액티브 시니어 캠프[국내성지순례. 인천&강화], 1박 2일' },
                        { date: '2023. 2. 1(수)', content: '수요오전예배 시작' },
                        { date: '2023. 2. 19(일)', content: `창조세계 회복을 위한 '사순절 탄소 금식', 7주` },
                        { date: '2023. 5.', content: '빛의교회 가정예배, 4주 과정[키트 제작&발송]' },
                        { date: '2023. 5. 25(목)', content: `미라클즈 온 써스데이 '꽃모닝 프로젝트' 시작, 매주 목요일 7주[상반기&하반기]` },
                        { date: '2023. 6. 25(일)', content: '필리핀 선교사 파송[박철용,박민경]' },
                        { date: '2023. 7. 19(수) ~ 26(수)', content: '레바논 아웃리치 재개' },
                        { date: '2023. 8. 9(수)', content: '관악구 삼성동 주민센터와 빛의교회 업무협약 체결' },
                        { date: '2023. 10. 22(일)', content: '케냐 꿈꾸는 놀이터를 위한 워킹포미라클' },
                        { date: '2023. 11. 2(일)', content: '빛의교회 권사임직[강금숙 외 11명]' },
                        { date: '2023. 11. 10(금) ~ 11(토)', content: `관악구 삼성동 독거 어르신을 위한 '넉넉 프로젝트'` },
                    ],
                    '2022년': [
                        { date: '2022. 4. 18 ~ 7. 17', content: '담임목사님 안식월' },
                        { date: '2022. 5. 4 ~ 6. 15(수)', content: '빛의교회 첫 지역별[4개지역] 성경공부, 6주 과정' },
                        { date: '2022. 7. 28(목) ~ 8. 5(금)', content: '케냐 아웃리치[코로나 이후 해외 아웃리치 재개]' },
                        { date: '2022. 8. 10(수) ~ 16(화)', content: '필리핀 아웃리치' },
                        { date: '2022. 10. 2(일)', content: '온라인으로 성찬예식 참여[사전 성찬키트 발송]' },
                        { date: '2022. 11. 9 ~ 23(수)', content: '중보기도학교, 3주 과정' },
                    ],
                    '2022년 이전': [
                        { date: '2011. 12. 4', content: '빛의교회 오픈예배' },
                        { date: '2012. 10.', content: '노회가입 설립예배' },
                        { date: '2012. 11. 3(일) ~ 12. 1(일)', content: '2주년, 천 번의 예배, 천 번의 기도(빛의교회 모든 성도가 모두 합해 1000번의 주중예배)' },
                        { date: '2013. 4. 17 ~ 5. 29', content: '특별 수요말씀집회 사도신경 강해(6주) "믿음으로 걸어가리라"' },
                        { date: '2014. 9. 3 ~ 10. 15', content: '특별 수요말씀집회 주기도문 학교(6주)' },
                        { date: '2014. 9. 14 ~ 12. 7', content: '초신자를 위한 12주 과정 "기독교의 기본진리" 시작' },
                        { date: '2015. 11. 22(일)', content: '빛의교회 첫번째 권사 임직[이호일, 김순이 권사]' },
                        { date: '2016. 9. 4(일)', content: '방배동 성전 이전' },
                        { date: '2016. 12. 9(금)', content: '노숙자를 위한 사랑의 텀블러 나눔' },
                        { date: '2017. 1. 19(목) ~ 1. 28(토)', content: '겨울 케냐 아웃리치(마이스끼리아 교회 건축, 십계명학교)' },
                        { date: '2017. 2. 19(일)', content: '케냐 선교사 파송(이정도, 배수연)' },
                        { date: '2018. 5. 27(일)', content: 'Working for Miracle 미혼모자녀돕기 캠패인(매월 넷째 주일 봉사 지속)' },
                        { date: '2018. 7. 24(화) ~ 8. 1(수)', content: '여름 해외 아웃리치 - 레바논 난민캠프' },
                        { date: '2018. 9. 2(일)까지', content: '케냐 마사이 마을 영어성경 보급' },
                        { date: '2019. 5. 26(일)', content: '3부 예배 시작' },
                        { date: '2019. 12. 14(토)', content: 'Give 미 프로젝트 신림동 독거어르신 섬김 시작' },
                        { date: '2019. 12. 14(토)', content: 'Give 미 프로젝트 신림동 독거어르신 섬김 시작' },
                        { date: '2020. 1. 24(금) ~ 2. 1(토)', content: '케냐 아웃리치[엔게레수나 빛의교회 봉헌예배]' },
                        { date: '2020. 3. 1(일)', content: '온라인예배 시작[코로나19 감염 심각단계로 감염 예방]' },
                        { date: '2020. 5. 23(토)', content: '비대면 워킹포미라클[용산가족공원] / 미혼모 자녀들을 위한 걷기대회' },
                        { date: '2020. 12. 11(금)', content: '2020 빛의교회 온라인 전도집회 "우리집에 놀러와" / 빛의속도로' },
                        { date: '2021. 2. 21(일)', content: '온라인(ZOOM) 새가족등록' },
                        { date: '2021. 9. 19(일)', content: '엘키즈 노래하는 백일장' },
                    ]
                };
