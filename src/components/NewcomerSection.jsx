...
const faqs = [
    {
        ...
        answer: `환영합니다! 빛의교회 등록하기 원하시는 분은 새가족교육 5주 과정을 이수하셔야 합니다. '환영합니다' 페이지에서 '새가족 온라인 등록'을 작성해주시면 담당 교역자가 연락드립니다.`
    },
    {
        category: '새가족교육',
        question: '빛의교회는 어느 교단 소속인가요?',
        answer: '대한예수교장로회 통합측 소속입니다.'
    },
    {
        category: '사역활동',
        question: '빛의교회가 가장 중요하게 추구하는 방향은 무엇인가요?',
        answer: '예배와 선교, 말씀과 다음세대입니다.'
    }
];
